...
var Application = (function () {
    function Application() {
        ...
        this.flashVideoEmbed = (document.querySelector('embed#flashVideoEmbed'));
    ...
    Application.prototype.initializeFlash = function () {
        ...
        var takePicture = function () {
            try {
                _this.flashVideoEmbed.ccCapture();
            }
            catch (e) {
                console.log(e);
            }
        ...
        this.flashVideoEmbed.onactivate = function () {
            try {
                // why doesn't the flash movie load?
                _this.flashVideoEmbed.ccInit();
            }
            catch (e) {
                console.log(e);
            }
